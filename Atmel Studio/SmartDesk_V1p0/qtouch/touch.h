...
#define NODE_0_PARAMS                                                                                                  \
	{                                                                                                                  \
		X(1), Y(0), 0, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_12), NODE_GAIN(GAIN_2, GAIN_1), FILTER_LEVEL_16         \
	}
#define NODE_1_PARAMS                                                                                                  \
	{                                                                                                                  \
		X(3), Y(0), 0, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_12), NODE_GAIN(GAIN_2, GAIN_1), FILTER_LEVEL_16         \
	}
#define NODE_2_PARAMS                                                                                                  \
	{                                                                                                                  \
		X(5), Y(0), 0, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_12), NODE_GAIN(GAIN_2, GAIN_1), FILTER_LEVEL_16         \
	}
#define NODE_3_PARAMS                                                                                                  \
	{                                                                                                                  \
		X(7), Y(0), 0, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_12), NODE_GAIN(GAIN_2, GAIN_1), FILTER_LEVEL_16         \
	}

// DRO: Analog gain increased from GAIN_1 to GAIN_4
...
#define SCROLLER_0_PARAMS                                                                                              \
	{                                                                                                                  \
		SCROLLER_TYPE_SLIDER, 0, 4, SCROLLER_RESOL_DEADBAND(SCR_RESOL_8_BIT, SCR_DB_10_PERCENT), 8, 20                 \
	}
